...
/* harmony import */ var nextjs_cors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9267);
...
/* harmony import */ var _utils_database__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9056);
  ...
  try {
    ...
    switch (method) {
      case 'PUT':
        ...
        const {
          db
        } = await (0,_utils_database__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)();
        const response = await db.collection('classes').updateOne({
...
var __webpack_exports__ = (__webpack_exec__(6057));
